  ...
  <div class="form-container">
    ...
    <form class="form" id="questForm" method="POST">
      <div class="form-group">
        <h2>Edit Question 3</h2>
        <br>
        <label for="q3">Question</label>
        <input type="text" id="q3" name="q3" required>
      </div>
      <div class="form-group">
        <label for="q3_a">Answer Choice A</label>
        <input type="text" id="q3_a" name="q3_a" required>
      </div>
      <div class="form-group">
        <label for="q3_b">Answer Choice B</label>
      ...
      <div class="form-group">
        ...
        <div class="radio-inputs">
          <label class="radio">
            <input type="radio" name="ca_3" value="A" required>
            <span class="name">A</span>
          </label>
          <label class="radio">
            <input type="radio" name="ca_3" value="B" required>
            <span class="name">B</span>
          </label>
              
          <label class="radio">
            <input type="radio" name="ca_3" value="C" required>
            <span class="name">C</span>
          </label>
          <label class="radio">
            <input type="radio" name="ca_3" value="D" required>
